...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/dabl-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10567&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/dabl-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `dabl` can be installed with:

```
conda install dabl
```

It is possible to list all of the versions of `dabl` available on your platform with:
